...
/**
 * @description Pizzaria Welcome Page.
 */
            ...
            <StySpanContainer>
                <span>Seja bem vindo(a) a Pizzaria da Stoom</span>
                    <StySpanButton>
                        ...
                        <PizzariaFillButton id="button-id" action={() => changeRoute('pizza-of-day')} width="125px" title="Eu Quero"/>
                    </StySpanButton>
                <span>Mas caso você queira montar a sua pizza, basta clicar no botão "Próximo"</span>
                <span>Passo 1 de 7</span>
            </StySpanContainer>
            <StyButtonContainer>
                <PizzariaFillButton id="button-id" action={() => changeRoute('pizza-type-of-pasta')} title="Próximo"/>
            </StyButtonContainer>
        </PizzariaPage>
    );
}
